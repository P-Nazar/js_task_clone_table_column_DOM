...
headerRow.insertBefore(newHeaderCell, headerRow.children[headerRow.children.length - 1]);
const newFooterCell = newHeaderCell.cloneNode(true);
const footerRow = table.querySelector("tfoot tr");
footerRow.insertBefore(newFooterCell, footerRow.children[footerRow.children.length - 1]);
